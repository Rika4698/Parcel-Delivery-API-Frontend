...
export const UpdateStatusModal: FC<UpdateStatusModalProps> = ({
  ...
  const availableStatuses: ParcelStatus[] = ["PENDING", "CANCELLED"];
    ...
    <div className="fixed inset-0 bg-[#00000051] bg-opacity-60 z-50 flex justify-center items-center p-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              <select
                ...
                value={newStatus}
                onChange={(e) =>
                  setNewStatus(e.target.value as ParcelStatus)
                }
          ...
          <div className="flex justify-end gap-4 p-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-300 dark:border-gray-700 rounded-b-lg">
            <button
              type="button"
              onClick={onClose}
