...
export default function ContactMessage() {
  ...
  return (
    <div className=" min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-5xl mx-auto  rounded-lg shadow-sm border border-slate-200">
        ...
        <div className="flow-root">
          {contactMessages.length === 0 && !isLoading ? (
            <div className="text-center p-12">
              <BsInbox className="mx-auto text-6xl text-slate-300 mb-4" />
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="col-span-2 md:col-span-2 flex items-center justify-end gap-4">
                        ...
                        {isExpanded ? (
                          <BsChevronUp className="text-slate-500" />
                        ) : (
